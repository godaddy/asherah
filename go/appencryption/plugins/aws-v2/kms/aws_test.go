...
func (c *MockClient) Encrypt(ctx context.Context, input *kms.EncryptInput, opts ...func(*kms.Options)) (*kms.EncryptOutput, error) {
...
func (c *MockClient) GenerateDataKey(ctx context.Context, input *kms.GenerateDataKeyInput, opts ...func(*kms.Options)) (*kms.GenerateDataKeyOutput, error) {
	args := c.Called(ctx, input, opts)
...
func (c *MockClient) Decrypt(ctx context.Context, input *kms.DecryptInput, opts ...func(*kms.Options)) (*kms.DecryptOutput, error) {
	args := c.Called(ctx, input, opts)
...
func TestAWSKMS_NewAWSKMSClient(t *testing.T) {
	...
	client := newAWSKMSClient(cfg, preferredRegion, preferredRegionARN)
...
func TestAWSKMS_DecryptKey(t *testing.T) {
	...
	preferredClient.On("Decrypt", mock.Anything, mock.Anything, mock.Anything).Return(
	...
	usEast2Client.On("Decrypt", mock.Anything, decryptInput, mock.Anything).Return(
		&kms.DecryptOutput{
...
func TestAWSKMS_DecryptKey_ReturnsErrorIfKMSDecryptFails(t *testing.T) {
	...
	preferredClient.On("Decrypt", mock.Anything, mock.Anything, mock.Anything).
...
func TestAWSKMS_DecryptKey_ReturnsErrorIfDEKDecryptFails(t *testing.T) {
	...
	preferredClient.On("Decrypt", mock.Anything, decryptInput, mock.Anything).Return(
		&kms.DecryptOutput{
			Plaintext: plaintextKey,
		}, nil)
...
func TestAWSKMS_EncryptAllRegions(t *testing.T) {
	...
	usEast2Client := new(MockClient)
	usEast2Client.On("Encrypt", mock.Anything, input, mock.Anything).Return(&kms.EncryptOutput{
		CiphertextBlob: encryptedKEK,
		KeyId:          &usEast2ARN,
	}, nil)
...
func TestAWSKMS_EncryptAllRegions_ReturnsEmptyKeyOnError(t *testing.T) {
	preferredClient := new(MockClient)
	preferredClient.On("Encrypt", mock.Anything, mock.Anything, mock.Anything).
		Return(nil, errors.New(genericErrorMessage))
...
func TestAWSKMS_GenerateDataKey(t *testing.T) {
	preferredClient := new(MockClient)
	preferredClient.On("GenerateDataKey", mock.Anything, mock.Anything, mock.Anything).Return(nil, errors.New(genericErrorMessage))
	...
	usEast2Client.On("GenerateDataKey", mock.Anything, dataKeyIn, mock.Anything).Return(dataKeyOut, nil)
	...
	if assert.NoError(t, err) {
		...
		preferredClient.AssertCalled(t, "GenerateDataKey", mock.Anything, mock.Anything, mock.Anything)
	}
}
