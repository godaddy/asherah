...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.18.1 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.7.67 // indirect
