...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.15.26 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.7.61 // indirect
