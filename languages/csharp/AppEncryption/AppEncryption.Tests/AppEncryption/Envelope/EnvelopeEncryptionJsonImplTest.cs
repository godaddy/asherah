...
namespace GoDaddy.Asherah.AppEncryption.Tests.AppEncryption.Envelope
{
    ...
    public class EnvelopeEncryptionJsonImplTest : IClassFixture<MetricsFixture>
    {
        private readonly AppEncryptionPartition appEncryptionPartition =
            new AppEncryptionPartition("shopper_123", "payments", "ecomm");
        ...
        private readonly Mock<IMetastorePersistence<JObject>> metastorePersisteneMock;
        ...
        public EnvelopeEncryptionJsonImplTest()
        {
            ...
            metastorePersisteneMock = new Mock<IMetastorePersistence<JObject>>();
            ...
            envelopeEncryptionJsonImplSpy = new Mock<EnvelopeEncryptionJsonImpl>(
                ...
                metastorePersisteneMock.Object,
        ...
        private void TestEncryptPayload()
        {
            ...
            KeyMeta intermediateKeyMeta = new KeyMeta(appEncryptionPartition.IntermediateKeyId, ikDateTime);
        ...
        private void TestGetLatestOrCreateIntermediateKeyWithEmptyMetastoreShouldCreateSuccessfully()
        {
            ...
            systemCryptoKeyMock.Setup(x => x.GetCreated()).Returns(skDateTime);
            metastorePersisteneMock.Setup(x => x.Store(It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<JObject>()))
                .Returns(true);
            ...
            metastorePersisteneMock.Verify(x => x.Store(appEncryptionPartition.IntermediateKeyId, ikDateTime, It.IsAny<JObject>()));
        ...
        private void TestGetLatestOrCreateIntermediateKeyWithLatestAndNotExpiredShouldUseLatest()
        {
            ...
            CryptoKey actualIntermediateKey = envelopeEncryptionJsonImplSpy.Object.GetLatestOrCreateIntermediateKey();
            Assert.Equal(intermediateCryptoKeyMock.Object, actualIntermediateKey);
            metastorePersisteneMock.Verify(x => x.Store(It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<JObject>()), Times.Never);
            intermediateCryptoKeyMock.Verify(x => x.Dispose(), Times.Never);
        }
        ...
        private void TestGetLatestOrCreateSystemKeyWithEmptyMetastoreShouldCreateSuccessfully()
        {
            ...
            metastorePersisteneMock.Verify(x => x.Store(appEncryptionPartition.SystemKeyId, skDateTime, It.IsAny<JObject>()));
        ...
        private void TestLoadKeyRecord()
        {
            ...
            metastorePersisteneMock.Setup(x => x.Load(It.IsAny<string>(), It.IsAny<DateTimeOffset>()))
        ...
        private void TestLoadLatestKeyRecord()
        {
            ...
            metastorePersisteneMock.Setup(x => x.LoadLatestValue(It.IsAny<string>()))
                .Returns(Option<JObject>.Some(keyRecord.ToJson()));
        ...
        {
            metastorePersisteneMock.Setup(x => x.LoadLatestValue(It.IsAny<string>())).Returns(Option<JObject>.None);
