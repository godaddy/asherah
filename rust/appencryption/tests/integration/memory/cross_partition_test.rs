...
async fn test_cross_partition_decrypt_with_different_partitions() {
    ...
    let drr1 = session1.encrypt(&data).await
    ...
    assert!(decrypt_result.is_err(), "Cross-partition decrypt should fail");
