...
const LOAD_LATEST_QUERY: &str = "SELECT key_record FROM encryption_key WHERE id = ? ORDER BY created DESC LIMIT 1";
const STORE_KEY_QUERY: &str = "INSERT INTO encryption_key (id, created, key_record) VALUES (?, ?, ?)";
