...
use crate::{KeyType, Options, Provider, Reporter, Stats};
...
fn update_stats(stats: &mut Stats, metastore: &DelayedMetastore, kms: &TrackedKMS, requests: u64) {
    ...
    stats.metastore_op_count = stats.metastore_load_count
        + stats.metastore_load_latest_count
        + stats.metastore_store_count;
    ...
    stats.op_rate =
        (stats.metastore_op_count + stats.kms_op_count) as f64 / stats.request_count as f64;
}
