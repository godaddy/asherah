...
fn test_prot_flags() {
    ...
    assert_eq!(MemoryProtection::NoAccess as u32, 1, "NoAccess value is incorrect");
    assert_eq!(MemoryProtection::ReadOnly as u32, 2, "ReadOnly value is incorrect");
    assert_eq!(MemoryProtection::ReadWrite as u32, 6, "ReadWrite value is incorrect");
}
